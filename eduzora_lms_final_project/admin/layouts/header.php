...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>dist-admin/css/magnific-popup.css">
    ...
    <script src="<?php echo BASE_URL; ?>dist-admin/js/jquery.magnific-popup.min.js"></script>
