...
if(isset($_POST['form_submit'])) {
    try {
        ...
        header('location: '.BASE_URL.'instructor-reset-password.php?email='.$_REQUEST['email'].'&token='.$_REQUEST['token']);
        exit;
    }
}
?>
...
<div class="page-top" style="background-image: url('<?php echo BASE_URL; ?>uploads/banner.jpg')">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>Instructor Reset Password</h2>
                <div class="breadcrumb-container">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo BASE_URL; ?>">Home</a></li>
                        <li class="breadcrumb-item active">Instructor Reset Password</li>
                    </ol>
                </div>
            </div>
        </div>
